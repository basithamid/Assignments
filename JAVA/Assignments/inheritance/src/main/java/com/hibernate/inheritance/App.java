...
import com.hibernate.inheritance.tablepersubclass.Vehicle;
import com.hibernate.inheritance.tablepersubclass.Car;
import com.hibernate.inheritance.tablepersubclass.Bike;
...
//    	singleTable(sessionFactory);
    	...
    	tablepersubclass(sessionFactory);
    	sessionFactory.close();
    }
    private static void tablepersubclass(SessionFactory sessionFactory) {
