...
/***/ function(module, exports, __webpack_require__) {
	...
	//import {getTotalCashInBank} from './components/classes_modules.js';
	//getTotalCashInBank();
...
/***/ function(module, exports) {
	...
	exports.armstrongGenerator = armstrongGenerator;

	var _marked = [armstrongGenerator].map(regeneratorRuntime.mark);

	function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }

	function testGenerator() {
	    var gen = armstrongGenerator();
	    console.log('Armstrong number: ', gen.next());
	    console.log('Armstrong number: ', gen.next());
	    console.log('Armstrong number: ', gen.next());
	    console.log('Armstrong number: ', gen.next());
	    console.log('Armstrong number: ', gen.next());
	...
	function armstrongGenerator() {
	    var i, digits, _ref, a, b, c;

	    return regeneratorRuntime.wrap(function armstrongGenerator$(_context) {
	        while (1) {
	            switch (_context.prev = _context.next) {
	                ...
	                case 2:
	                    ...
	                    _ref = [].concat(_toConsumableArray(digits)), a = _ref[0], b = _ref[1], c = _ref[2];
